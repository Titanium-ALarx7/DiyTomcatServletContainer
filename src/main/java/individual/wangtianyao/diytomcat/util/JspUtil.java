...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/pluginhelloweb",
                    "C:/Users/wty_AL/Documents/GitHub/pluginhelloweb/web",
                    null,true);
            File file = new File("C:/Users/wty_AL/Documents/GitHub/pluginhelloweb/web/index.jsp");
    ...
    public static void compileJsp(Context context, File file) throws JasperException {
        ...
        String workPath = new File(Header.workFolderPath, subFolder).getAbsolutePath() + File.separator;
    ...
    public static String getServletPath(String uri, String subFolder) {
        ...
        File tempFile = FileUtil.file(Header.workFolderPath, subFolder, tempPath);
    ...
    public static String getJspServletClassName(String uri, String subFolder) {
        File tempFile = FileUtil.file(Header.workFolderPath, subFolder);
